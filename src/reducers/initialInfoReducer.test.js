...
describe('initialInfoReducer', () => {
  it('should return the initial state', () => {
    const expected = [];
    const result = initialInfoReducer(undefined, [])

    expect(result).toEqual(expected);
  })

  it('should return state with the info added', () => {
    const mockState = [];
    ...
    const result = initialInfoReducer(mockState, mockAction)
